...
import { ArrowLeft, Phone, Briefcase, ExternalLink, Activity } from "lucide-react";
            ...
            <Card>
                <CardHeader className="flex flex-row items-start gap-6 space-y-0">
                    ...
                    <div className="space-y-1">
                        ...
                        <CardDescription>
                            Worker ID: #{worker.id.toString().padStart(4, '0')}
                        </CardDescription>
            ...
            <div className="space-y-4">
                <div className="flex items-center justify-between">
                    <h2 className="text-xl font-semibold tracking-tight">
                        Assigned Projects ({worker.projects.length})
                    </h2>
                    <Link href="/projects">
                                ...
                                {worker.projects.length === 0 && (
                                    <TableRow>
                                        <TableCell colSpan={4} className="text-center py-8 text-zinc-500">
                                            No active projects for this worker.
                                        </TableCell>
                                    </TableRow>
                                )}
                            </TableBody>
